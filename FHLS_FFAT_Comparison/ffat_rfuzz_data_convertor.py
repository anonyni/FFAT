...
# Example usage
datasets = {
    "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/normal_state.csv": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HJSON/normal_rfuzz.json",
    "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/overvoltage.csv": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HJSON/overvoltage_rfuzz.json",
    "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/clock_glitching.csv": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HJSON/clock_rfuzz.json",
    "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/rowhammer.csv": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HJSON/rowhammer_rfuzz.json",
    "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/unknown_data.csv": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HJSON/unknown_rfuzz.json"
}
...
if __name__ == "__main__":
    ...
    csv_to_hwf("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/normal_state.csv", "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HWF/normal_state.hwf")
    
    # 2) rowhammer.csv -> rowhammer.hwf
    csv_to_hwf("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/rowhammer.csv", "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HWF/rowhammer.hwf")

    csv_to_hwf("E:FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/clock_glitching.csv", "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HWF/clock_glitching.hwf")

    csv_to_hwf("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/overvoltage.csv", "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HWF/overvoltage.hwf")

    csv_to_hwf("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/unknown_data.csv", "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_HWF/unknown_data.hwf")    
...
if __name__ == "__main__":
    ...
    hjson_file = "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FHLS_HJSON/lock_cpp_afl_test.hjson"    # Replace with your HJSON file name
    csv_file = "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FHLS_CSV/lock_cpp_afl_test.csv"        # Desired CSV output file name
...
df_orig = pd.read_csv("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FHLS_CSV/cpp_afl2.csv")
...
df_combined.to_csv("E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FHLS_CSV/u_cpp_afl2.csv", index=False)
