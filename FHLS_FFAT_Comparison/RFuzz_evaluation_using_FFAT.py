...
DATASETS = {
    "trippel_synthetic": "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FHLS_CSV/u_cpp_afl1e.csv"
}
UNKNOWN_DATA_PATH = "E:/FFAT/Code_FFAT/FHLS_FFAT_Comparison/FFAT_CSV/unknown_data.csv"  # if applicable
